...
PROTOBUF_NAMESPACE_OPEN
template<> ::bapid::Empty* Arena::CreateMaybeMessage<::bapid::Empty>(Arena*);
...
class Empty final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:bapid.Empty) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:bapid.Empty)
 private:
  class _Internal;
